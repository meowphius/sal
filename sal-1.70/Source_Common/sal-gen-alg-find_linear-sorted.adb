...
package body SAL.Gen.Alg.Find_Linear.Sorted is
   ...
   begin
      ...
      loop
         ...
         -- First (Source); otherwise 1 would have been removed on the
         -- previous check.
         --
         -- If an item is removed, we do not advance Iterator, because
         -- we need to repeat the check with the new item.
         --
