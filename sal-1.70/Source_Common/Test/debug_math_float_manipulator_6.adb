...
with SAL.Math_Float_Manipulator_6.Text_IO; use SAL.Math_Float_Manipulator_6.Text_IO;
with SAL.Math_Float_Kraft_HC_Nominal;
procedure Debug_Math_Float_Manipulator_6
is
   use SAL.Math_Float;
   use SAL.Math_Float_Manipulator_6.Math;
   use SAL.Math_Float_Manipulator_6.Text_IO;
...
begin
   ...
   Test_Jacobian_Type :
   declare
      use SAL.Math_Float.DOF_3, Joint_Array_Real_Ops;
      ...
      is
         ...
         -- Generic_Inverse_Array_Math, so we don't need to test it here.
      begin
   ...
   declare
      ...
      function "+"
        (Left  : in SAL.Math_Float.DOF_6.Pose_Type;
         Right : in SAL.Math_Float.DOF_6.Dual_Cart_Vector_Type)
        return SAL.Math_Float.DOF_6.Pose_Type
        renames SAL.Math_Float.DOF_6."+";
      ...
      is
         use SAL.Math_Float.DOF_6, Joint_Array_Real_Ops;
      ...
      begin
         ...
         SAL.Math_Float.Text_IO.Num_Text_IO.Default_Exp := 3;
      ...
      is
         ...
         -- override global; make Jacobian sufficiently complex to see wrist
         -- singularity.
