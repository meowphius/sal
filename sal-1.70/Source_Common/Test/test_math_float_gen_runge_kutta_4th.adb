...
package body Test_Math_Float_Gen_Runge_Kutta_4th is
   ...
   begin
      return new String'("Test Math_Float.Gen_Runge_Kutta_4th");
   end Name;
   ...
   is
      ...
      procedure Constant_Integrator is new SAL.Math_Float.Gen_Runge_Kutta_4th
   ...
   is
      ...
      procedure Linear_Integrator is new SAL.Math_Float.Gen_Runge_Kutta_4th
         (State_Type         => Real_Type,
          Derivative_Type    => Real_Type,
          Compute_Derivative => State_Derivative);
   ...
   is
      ...
      procedure Quadratic_Integrator is new SAL.Math_Float.Gen_Runge_Kutta_4th
         (State_Type         => Real_Type,
          Derivative_Type    => Real_Type,
          Compute_Derivative => State_Derivative);
...
end Test_Math_Float_Gen_Runge_Kutta_4th;
