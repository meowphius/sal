...
begin
   ...
   begin
      ...
      -- full path coverage of sal.gen.lists.double.iterators.Copy_Before, Insert
      ...
      ----------
      -- full path coverage of sal.gen.lists.double.iterators.Delete (list, iterator), Delete (private)
      ...
      ----------
      -- full path coverage of sal.gen.lists.double.iterators.Insert_After (Insert covered above)
      ...
      ----------
      -- full path coverage of sal.gen.lists.double.iterators.Insert_Before (Insert covered above)
      ...
      ----------
      -- full path coverage of sal.gen.lists.double.iterators.Splice_After
      ...
      ----------
      -- full path coverage of sal.gen.lists.double.iterators.Splice_Before
   ...
   --
   -- There are two differences in the body of sal.gen.lists.double for
   -- these types: Free_Item and Copy are not null. Free_Item is only called from Delete
   -- (private), we need to do at least one deletion. This mostly shows that you
