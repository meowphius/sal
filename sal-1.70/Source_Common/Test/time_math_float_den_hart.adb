...
is
   ...
   is
   begin
      Result := SAL.Math_Float.Den_Hart.Mult (Pose, Den_Hart, Position);
   end Call_Mult1;
   ...
   is
      use DOF_6;
   begin
      Result := Pose * SAL.Math_Float.Den_Hart.To_Pose (Den_Hart, Position);
   end Call_Long_Calculation1;

   procedure Call_Mult2
   is begin
      Result := SAL.Math_Float.Den_Hart.Mult (Den_Hart, Position, Pose);
   end Call_Mult2;
   ...
   is
      use DOF_6;
   begin
      Result := SAL.Math_Float.Den_Hart.To_Pose (Den_Hart, Position) * Pose;
   end Call_Long_Calculation2;

   function Time_Null is new Gen_Time_Me (Time_Me => Time_Aux.Call_Null);
   function Time_Mult1 is new Gen_Time_Me (Time_Me => Call_Mult1);
   function Time_Mult2 is new Gen_Time_Me (Time_Me => Call_Mult2);
   function Time_Long_Calculation1 is new Gen_Time_Me (Time_Me => Call_Long_Calculation1);
   function Time_Long_Calculation2 is new Gen_Time_Me (Time_Me => Call_Long_Calculation2);
