...
is
   ...
   package Bus_Order_Convert is new SAL.Gen.Word_Order_Convert
      (Bus_Word_Type       => Bus_Word_Type,
       Bus_Index_Type      => Bus_Index_Type,
       Bus_Word_Array_Type => Bus_Word_Array_Type);

   package Float_32_Convert is new Bus_Order_Convert.Scalar_32 (Host_Float_32_Type);
   package Float_64_Convert is new Bus_Order_Convert.Scalar_64 (Host_Float_64_Type);
   package Fixed_32_Convert is new Bus_Order_Convert.Scalar_32 (Host_Fixed_32_Type);
