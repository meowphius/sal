...
with Test_Math_Float_Utils;   use Test_Math_Float_Utils;
package body Test_Math_Float_Den_Hart is
   ...
   is
      pragma Unreferenced (T);
   begin
      return new String'("Test SAL.Math_Float.Den_Hart");
   end Name;
   ...
   begin
      Register_Routine (T, Test_Den_Hart'Access, "Den_Hart");
      Register_Routine (T, Test_Mult'Access, "Mult");
   end Register_Tests;

end Test_Math_Float_Den_Hart;
