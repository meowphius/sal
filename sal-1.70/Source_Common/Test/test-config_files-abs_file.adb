...
package body Test.Config_Files.Abs_File is
   ...
   is
      ...
      File_Name          : constant String := "$SAL/Build/test-config_files-abs.config";
      Expanded_File_Name : constant String := SAL.File_Names.Replace_Environment_Variables (File_Name);
