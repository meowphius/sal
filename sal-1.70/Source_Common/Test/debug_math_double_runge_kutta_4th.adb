...
begin
   ...
   declare
      ...
      is
         use SAL.Math_Double.Stats.Image;
      begin
         Put (Image (Item.Position, Mean_Exp => 3, SD_Exp => 3));
         New_Line;
         Put (Image (Item.Momentum, Mean_Exp => 3, SD_Exp => 3));
         New_Line;
      end Put;
      ...
      procedure Integrator is new SAL.Math_Double.Gen_Runge_Kutta_4th
