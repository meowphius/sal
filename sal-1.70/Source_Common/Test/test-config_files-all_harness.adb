--  Abstract :
--
--  Run all tests on Grace.Config_Files.
--
...
procedure Test.Config_Files.All_Harness
is

   Suite  : constant Access_Test_Suite := Test.Config_Files.All_Suite;
...
end Test.Config_Files.All_Harness;
