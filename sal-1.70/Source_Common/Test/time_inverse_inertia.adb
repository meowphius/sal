...
is
   ...
   function Time_Det_Inverse is new Gen_Time_Me (Call_Det_Inverse);
   ...
   function Time_Fast_Inverse_1 is new Gen_Time_Me (Call_Fast_Inverse_1);
   ...
   function Time_Fast_Inverse_2 is new Gen_Time_Me (Call_Fast_Inverse_2);
