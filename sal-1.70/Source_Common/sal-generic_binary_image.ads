...
-- Return a base 2 image of Item, padded with leading zeros to Nibbles
-- * 4 bits, and inserting '_' between nibbles. If Nibbles * 4 is too
-- small, leading bits are silently truncated.
