...
is
   use Math_Scalar, Math_DOF_3, Math_DOF_3.Cart_Vector_Ops, Math_DOF_6, Math_DOF_6.DCV_Ops;
...
begin
   ...
   Link_Wrench (Joint_Index_Type'Last) :=
     Transform_Force (-Center (Mass (Joint_Index_Type'Last)),
   ...
   for Joint in reverse Joint_Index_Type'First .. Pred (Joint_Index_Type'Last) loop
      Link_Wrench (Joint) :=
        Transform_Force (-Center (Mass (Joint)),
