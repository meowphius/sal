...
package SAL.Gen.Queues.Gen_Bounded_Nonlimited is
   ...
   type Queue_Type (Size : Positive; Overflow_Handling : Overflow_Action_Type) is private;
...
private
   ...
   type Queue_Type (Size : Positive; Overflow_Handling : Overflow_Action_Type) is record
