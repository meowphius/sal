...
-- see spec
--
-- Copyright (C) 1998 - 2000, 2002 Stephen Leake.  All Rights Reserved.
--
...
package body SAL.Gen.Lists.Double.Iterators is
   ...
   is
      -- copy from Last first, so we can catch Before between First and Last
   ...
   is
      ...
      Dest_After   : Node_Access_Type := Node_Access_Type (After);
   ...
   is
      ...
      Dest_Before  : Node_Access_Type := Node_Access_Type (Before);
   begin
      if Source_First = null then
         if Source.Head = null then
            pragma Assert (Source.Tail = null);
