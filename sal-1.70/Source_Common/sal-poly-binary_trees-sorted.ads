...
generic
   ...
   -- Item_Type. Then To_Item_Node and To_Item should just return Item,
   -- and Free_Item should be null. See Sal.Aux.Definite_Private_Items.
   --
   -- If Item_Type is indefinite or limited, Item_Node_Type should
   -- be 'access Item_Type'. Then To_Item_Node should allocate Item
   -- and return a pointer to it, and Free_Item should be
...
package SAL.Poly.Binary_Trees.Sorted is
   ...
   --
   -- From is processed top down; merging into a null tree results in the
   -- same tree structure.
   --
