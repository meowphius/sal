...
package body SAL.Gen_Math.Gen_DOF_2.Gen_Text_IO is
   ...
   begin
      ...
      Put_Item (File, Item.Left_Bottom,
   ...
   begin
      Check (File, "(");
      if Named_Association_Record then Check (File, "Left_Bottom => "); end if;
      Get_Item (File, Temp_Item.Left_Bottom,
         Named_Association => Named_Association_Component);
      Check (File, ",");
      Skip_Whitespace (File);
      if Named_Association_Record then Check (File, "Right_Top => "); end if;
      Get_Item (File, Temp_Item.Right_Top,
         Named_Association => Named_Association_Component);
      Check (File, ")");
   end Get;
