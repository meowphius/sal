...
package Gtk.GEntry.Signal is
   ...
   procedure Connect_Changed
     (Editable : access Gtk.Editable.Gtk_Editable_Record'Class;
      Handler  : in     Gtk.Editable.Signal.Event_Handler)
     renames Gtk.Editable.Signal.Connect_Changed;

   procedure Connect_Focus_In_Event
     (Widget  : access Gtk.Widget.Gtk_Widget_Record'Class;
      Handler : in     Gtk.Widget.Signal.Boolean_Event_Handler)
     renames Gtk.Widget.Signal.Connect_Focus_In_Event;

   procedure Connect_Focus_Out_Event
     (Widget  : access Gtk.Widget.Gtk_Widget_Record'Class;
      Handler : in     Gtk.Widget.Signal.Boolean_Event_Handler)
     renames Gtk.Widget.Signal.Connect_Focus_Out_Event;
