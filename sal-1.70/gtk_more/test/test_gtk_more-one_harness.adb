--  Abstract :
--
--  Run one test of gtk_more stuff.
--
...
procedure Test_Gtk_More.One_Harness
is
   Suite  : constant Access_Test_Suite := new Test_Suite;
   Result : AUnit.Test_Results.Result;

begin
   Add_Test (Suite, new Test_Gtk_More.Message_Box.Test_Case (Debug_Level => 1));

   Run (Suite.all, Result);
   AUnit.Test_Results.Text_Reporter.Report (Result);
end Test_Gtk_More.One_Harness;
