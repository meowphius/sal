...
--                            $Revision: 1.4 $
--                                                                          --
--                Copyright (C) 2000, 2002, 2003, 2004 Ada Core Technologies, Inc.            --
--                                                                          --
...
package body AUnit.Test_Cases is
   ...
   Set_Up_Case_String    : aliased String := "Set_Up_Case";
   Tear_Down_Case_String : aliased String := "Tear_Down_Case";
   ...
   begin
      ...
      exception
      when E : others =>
         Add_Error (R, Name (Test_Case'Class (Test)), Set_Up_Case_String'Access, E);
         return;
      end;
      ...
      exception
      when E : others =>
         Add_Error (R, Name (Test_Case'Class (Test)), Tear_Down_Case_String'Access, E);
      end;
